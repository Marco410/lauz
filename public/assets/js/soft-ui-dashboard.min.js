...
function navbarFixed(e) {
    var t = ["blur", "shadow-blur", "mt-4", "left-auto", "top-1"];
...
function initNavs() {
    total.forEach(function (l, e) {
        var o = document.createElement("div"),
            t = l.querySelector("li:first-child").cloneNode();
...
const iconNavbarSidenav = document.getElementById("iconNavbarSidenav"),
    ...
    iconHideShowSidenav = document.getElementById("iconHideShowSidenav");
...
iconNavbarSidenav && iconNavbarSidenav.addEventListener("click", toggleSidenav),
    iconHideShowSidenav.addEventListener("click", toggleHideShowSidenav),
    iconSidenav && iconSidenav.addEventListener("click", toggleSidenav);

function toggleHideShowSidenav() {
    let links = document.querySelectorAll(".nav-link-text");
    let bran = document.querySelector(".brand-title");
