        ...
        <div class="card-body p-5" >
          <div class="row">
                ...
                <div class="col-sm-6 d-flex ">
                  <div style="width: 100%; height: 200px; border-radius: 8px 0px 0px 8px; background-color: white" class="text-center">
                    <br>
                    <br>
                    <br>
                  <label >Sync your Broker</label>
                  </div>
                  <div style="width: 100%; height: 200px; border-radius: 0px 8px 8px 0px; flex-direction: column;justify-content: center; align-items: center " class="bg-secondary text-center ">
                    <br>
                    <br>
                    <br>
                    <label class="text-white" >Platform Transmit</label>
                  </div>
